...
__auto_imports__ = [
   ...
   {"lib": "moviepy",
     "version": "2.2.1",
     "import": 'moviepy.video.fx.MirrorX.MirrorX',
   }
]
...
def apply(input_source, apply_to='both'):
    """
    Flips the provided input clip horizontally and its mask.
    ...
    """
    output = input_source.with_effects([MirrorX(apply_to=apply_to)])
    return output
